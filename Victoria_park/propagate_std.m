function [xe, Pe] = propagate_std(xe,Pe,dt,v_m,omega_m,sigma_v,sigma_w)


J = [0 -1; 1 0];
Q = [sigma_v^2 0 0;0 sigma_v^2/100 0;0   0    sigma_w^2];

xR_k_k = xe(1:3,1);


% % propagate state
xe(1:3,1) = [ xe(1:2) + rot(xe(3))*v_m*dt;
